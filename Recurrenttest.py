...
class info:
    ...
    def remember(self):
        ...
        return np.concatenate(np.array(self.imagem)), np.array(self.acoes), np.array(self.recompensa), np.concatenate(np.array(self.nexts)), np.array(self.done)
...
if __name__ == "__main__":
    ...
    state_size = 100800#env.observation_space.shape[0]
    ...
    for e in range(EPISODES):
        ...
        if e % 100 == 0 and e != 0:
            agent.save("Breakout-5-dqn{}.h5".format(e))
